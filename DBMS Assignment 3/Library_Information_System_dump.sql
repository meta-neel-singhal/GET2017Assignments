...
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book11", 5, '2016-03-13', 510.00, 'AVAILABLE');
...
INSERT INTO `book_return`(`return_date`, `accession_no`, `member_id`, `issue_date`) VALUES('2017-10-04', "Book1", 3, '2017-04-21');
