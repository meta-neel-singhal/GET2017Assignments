...
CREATE TABLE `book_issue`(
   ...
   /* CHECK (IF ((SELECT status FROM books WHERE books.accession_no = NEW.accession_no AND books.issue_date = NEW.issue_date)) IN (FALSE) THEN TRUE
    ELSE FALSE end if),
...
CREATE TRIGGER check_book_issue
    ...
    IF((SELECT status 
        FROM books  
        WHERE books.accession_no = NEW.accession_no) = FALSE)
    THEN
...
CREATE TRIGGER check_book_issue
    ...
    BEGIN
    SET NEW.`due_date` = CURDATE() + INTERVAL 15 day;
        IF((SELECT status FROM books WHERE books.accession_no = NEW.accession_no) IN (FALSE))
...
CREATE TRIGGER check_book_return
    ...
    BEGIN
        SELECT IFNULL((SELECT return_date 
               ...
               LIMIT 1) , UPDATE books SET status = FALSE WHERE books.accession_no = NEW.accession_no);
    END ;
    DELIMITER ;
*/
...
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book1", 1, '2017-07-14', 500.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book2", 2, '2017-04-23', 110.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book3", 3, '2017-11-15', 110.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book4", 4, '2016-05-16', 215.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book5", 5, '2016-03-13', 510.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book6", 6, '2015-04-30', 220.00, TRUE);
...
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book5", 5, '2016-03-13', 510.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book6", 6, '2015-04-30', 220.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book7", 1, '2013-11-23', 235.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book8", 2, '2015-02-23', 240.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book9", 4, '2017-11-15', 110.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book10", 4, '2016-05-16', 215.00, TRUE);
INSERT INTO `books`(`accession_no`, `title_id`, `purchase_date`, `price`, `status`) VALUES("Book11", 1, '2016-03-13', 510.00, TRUE);
